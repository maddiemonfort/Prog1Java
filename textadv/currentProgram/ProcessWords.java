	...
	public String determineAction(String[] args) {
		...
		if(args[0].equals("exit")) {
			...
			try{
				...
				if(args[1].equals("friend")) {
					return "Gandalf, what's the elvish word for friend?";
				}
				else {
					return "Wrong";
				}
			...
			try {
				...
				if(args[1].equalsIgnoreCase("Ariadne")) {
		...
		//if first word is take
			...
			return "Try typing simple commands without articles or descriptive words. Also, try examining the room and things in the room for clues.";
		}
...
//remember to say that opening bag of winds ends the game abruptly.